...
const ABILITIES := {
	...
	"cure": {"name": "Cure", "icon": "res://assets/icons/potion_icon.png", "resource_cost": 20.0, "cooldown_ms": 5000, "kind": "ally_heal", "heal_percent": 0.20, "heal_below": 0.65},
	"benediction": {"name": "Benediction", "icon": "res://assets/icons/mana_ward_icon.png", "resource_cost": 25.0, "cooldown_ms": 35000, "kind": "self_heal", "heal_percent": 0.25},
