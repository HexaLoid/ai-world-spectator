...
const ENEMIES := {
	...
	"vault_skeleton": {
		...
		"max_hp": 620, "move_speed": 52.0, "attack_min": 8, "attack_max": 13, "aggro_range": 140.0,
	...
	"vault_wraith": {
		...
		"max_hp": 310, "move_speed": 84.0, "attack_min": 10, "attack_max": 15, "aggro_range": 200.0,
	...
	"bone_warden": {
		...
		"max_hp": 4900, "move_speed": 60.0, "attack_min": 25, "attack_max": 37, "aggro_range": 200.0,
	...
	"hollow_king": {
		...
		"max_hp": 11700, "move_speed": 66.0, "attack_min": 30, "attack_max": 44, "aggro_range": 260.0,
